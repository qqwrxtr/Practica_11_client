...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['login'])) {
        ...
        if ($user && password_verify($loginPassword, $user['password'])) {
            ...
            header("Location: /artur/home/");
            exit();
        } else {
            echo "Invalid email or password.";
        }
    } elseif (isset($_POST['signup'])) {
        $signupName = $_POST['logname'];
        $signupEmail = $_POST['logemail'];
        $signupPassword = $_POST['logpass'];
        ...
        if (!filter_var($signupEmail, FILTER_VALIDATE_EMAIL)) {
            ...
            mysqli_stmt_bind_param($stmt, "sss", $signupName, $signupEmail, $hashedPassword);
